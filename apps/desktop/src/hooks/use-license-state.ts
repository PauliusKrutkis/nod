...
/**
 * The one license-state subscription the purchase card and the update
 ...
 * app left running overnight re-derives it hourly rather than sitting on
 * yesterday's answer all session. `setLicenseState` is for the activation
