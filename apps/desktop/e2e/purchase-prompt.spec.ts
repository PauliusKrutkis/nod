 ...
 * stays fully usable behind it, Later dismisses it for the launch — even
 * mid-purchase, since checkout can be abandoned — and a completed browser
 * activation flips both the card and the trial badge without a reload. A
 * backend failure surfaces as copy inside the card, not a broken boot.
 */
